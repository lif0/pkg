...
func TestEstimatePayloadOf_nil(t *testing.T) {
	got := reflectx.EstimatePayloadOf(nil)
	want := 0
	if got != want {
...
func TestEstimatePayloadOf_int(t *testing.T) {
	t.Run("int", func(t *testing.T) {
		v := int(42)
		got := reflectx.EstimatePayloadOf(v)
		want := szInt
		if got != want {
			t.Errorf("got %d, want %d", got, want)
		}
	...
	t.Run("*int", func(t *testing.T) {
		v := int(42)
		pv := &v
		got := reflectx.EstimatePayloadOf(pv)
		want := szInt
		if got != want {
			t.Errorf("got %d, want %d", got, want)
		}
	...
	t.Run("*[]int non-nil", func(t *testing.T) {
		s := []int{1, 2, 3}
		ps := &s
		got := reflectx.EstimatePayloadOf(ps)
		want := 3 * szInt
		if got != want {
			t.Errorf("got %d, want %d", got, want)
		}
...
func TestEstimatePayloadOf_CustomStruct(t *testing.T) {
	t.Run("CustomStruct", func(t *testing.T) {
		v := CustomStruct{}
		got := reflectx.EstimatePayloadOf(v)
		want := reflectx.ErrFailEstimatePayload
		if got != want {
			t.Errorf("got %d, want %d", got, want)
		}
	})
	...
	t.Run("[]CustomStruct nil", func(t *testing.T) {
		...
		got := reflectx.EstimatePayloadOf(v)
		want := reflectx.ErrFailEstimatePayload // because we the EstimatePayloadOf don't know about CustomStruct
		if got != want {
			t.Errorf("got %d, want %d", got, want)
		}
	})
	...
	t.Run("[]*CustomStruct all nil", func(t *testing.T) {
		...
		got := reflectx.EstimatePayloadOf(v)
		want := reflectx.ErrFailEstimatePayload // since fallback to payloadArray, and struct unknown, Err
		if got != want {
			t.Errorf("got %d, want %d", got, want)
		}
	})
	...
	t.Run("[3]*CustomStruct all nil", func(t *testing.T) {
		...
		got := reflectx.EstimatePayloadOf(v)
		want := reflectx.ErrFailEstimatePayload // Err for unknown struct
		if got != want {
			t.Errorf("got %d, want %d", got, want)
		}
	})
